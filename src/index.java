...
public class index extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		...
		if(baselayerArr == null || mixinArr == null || seasoningArr == null || condimentArr == null || shellArr == null) {
			response.sendRedirect("/");
		} else {
			assemblyPage(request, response);
		}
	}
...
//		out.println("  </form>");
	...
	protected void assemblyPage(HttpServletRequest request, HttpServletResponse response)throws ServletException, IOException {
		response.setContentType("text/html");
		PrintWriter out = response.getWriter();
		out.println("<!DOCTYPE HTML PUBLIC \"-//W3C//DTD HTML 4.01 Transitional//EN\">");
		out.println("<HTML>");
